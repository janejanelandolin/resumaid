...
import PaymentsPopup from '@/components/payments/PaymentsPopup';
...
const DownloadButtons: React.FC<DownloadButtonsProps> = ({ resume, jobTitle }) => {
  ...
  const handleDownloadDocx = async () => {
    // Open payments popup instead of directly downloading
  ...
  return (
    <>
      ...
      <PaymentsPopup 
        isOpen={showPaymentsPopup}
        onClose={() => setShowPaymentsPopup(false)}
      />
    </>
  );
};
