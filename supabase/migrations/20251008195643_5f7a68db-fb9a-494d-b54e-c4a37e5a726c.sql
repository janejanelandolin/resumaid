...
-- Step 2: Drop ALL existing policies on session_logs
...
DROP POLICY IF EXISTS "Authenticated users can insert own sessions" ON public.session_logs;
...
-- Step 6: Add DELETE policy - only admins can delete (protects audit trail)
...
-- Step 7: Make user_id NOT NULL to prevent future NULL insertions
